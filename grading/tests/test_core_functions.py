...
class IsLabReportFileTest(TestCase):
    ...
    def test_priority_3_path_parsing_with_class(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            file_path = os.path.join(temp_dir, '计算机网络实验', '计算机1班', '实验1', '学生作业.docx')
    ...
    def test_priority_4_keyword_matching_experiment(self):
        ...
        result = is_lab_report_file(
            course_name='Physics Experiment'
        )
    ...
    def test_path_parsing_with_repository_dirs(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            file_path = os.path.join(temp_dir, 'homework', '计算机网络实验', '实验1', '学生作业.docx')
...
class WriteGradeToLabReportTest(TestCase):
    ...
    def test_write_grade_without_comment(self):
        ...
        success, modified_grade, modified_comment = write_grade_to_lab_report(doc, grade, comment=None)
    ...
    def test_update_existing_grade(self):
        ...
        # 更新评分
        success, modified_grade, modified_comment = write_grade_to_lab_report(doc, "A", "修改为优秀")
    ...
    def test_preserve_existing_comment(self):
        ...
        # 只更新评分，不提供新评价
        success, modified_grade, modified_comment = write_grade_to_lab_report(doc, "A", comment=None)
    ...
    def test_all_valid_grades(self):
        ...
        for grade in valid_grades:
            with self.subTest(grade=grade):
                ...
                success, modified_grade, modified_comment = write_grade_to_lab_report(doc, grade, "测试评价")
    ...
    def test_long_comment_handling(self):
        ...
        success, modified_grade, modified_comment = write_grade_to_lab_report(doc, "A", long_comment)
    ...
    def test_special_characters_in_comment(self):
        ...
        success, modified_grade, modified_comment = write_grade_to_lab_report(doc, "A", special_comment)
...
class ManualGradingIntegrationTest(TestCase):
    ...
    def setUp(self):
        """设置测试环境"""
        from django.contrib.auth.models import User
        from grading.models import Semester, Course, Homework, Repository
        from datetime import date
